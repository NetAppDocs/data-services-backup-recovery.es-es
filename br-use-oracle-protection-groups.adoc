...
[role="lead"]
Crea grupos de protección para gestionar las operaciones de backup de los recursos de Oracle Database. Un grupo de protección es una agrupación lógica de recursos, como bases de datos, que quieres proteger juntos.
...
* Haz ahora una copia de seguridad de un grupo de protección. Consulta link:br-use-oracle-backup.html["Haz copias de seguridad ahora de las cargas de trabajo de Oracle Database"].
...
Agrupa los recursos de Oracle Database que quieras proteger juntos en un grupo de protección.
...
. Selecciona las bases de datos que quieras incluir en el grupo de protección.
