...
* Realice una copia de seguridad de un grupo de protección ahora. Ver link:br-use-hyperv-backup.html["Realice copias de seguridad de las cargas de trabajo de Hyper-V ahora"] .
