...
* <<Agregar credenciales para los recursos del host>> para cualquier host Windows, Microsoft SQL Server, Oracle Database o Linux con el que NetApp Backup and Recovery necesite autenticarse. Esto incluye las credenciales del SO invitado usadas al restaurar archivos o carpetas.
...
Crea plantillas de transformación de recursos para guardar las transformaciones habituales que haces a los recursos mientras los restauras.

.Pasos
. Desde el menú NetApp Backup and Recovery , seleccione *Configuración*.
. Selecciona la flecha hacia abajo para expandir la sección *Resource modifer template*.
...
.. Opcionalmente, introduce un grupo de recursos, versión, nombre.
