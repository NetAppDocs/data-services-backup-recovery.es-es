...
. Busque la VM que desea restaurar en la lista y seleccione el botón *Restaurar máquina virtual* para esa VM.
+
Aparece una lista de instantáneas (puntos de restauración) creadas en esa máquina virtual.

. Habilite la casilla de verificación de la instantánea que desea restaurar.
...
*** *Almacén de datos*: Ingrese el nombre del almacén de datos donde desea restaurar la instantánea.
