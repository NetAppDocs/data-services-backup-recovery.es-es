...
*Rol de NetApp Console requerido:* rol de superadministrador de Backup and Recovery o rol de administrador de backup de Backup and Recovery. Si estás protegiendo datos almacenados en un clúster de Cloud Volumes ONTAP, también se requiere el rol de administrador de Cloud Volumes ONTAP. Obtén más información sobre link:reference-roles.html["Funciones y privilegios de backup y recuperación"]. https://docs.netapp.com/us-en/console-setup-admin/reference-iam-predefined-roles.html["Obtenga información sobre los roles de acceso a la NetApp Console para todos los servicios"^].
...
*Rol requerido de NetApp Console*: superadministrador de Backup and Recovery o rol de backup admin de Backup and Recovery. Si estás protegiendo datos almacenados en un clúster de Cloud Volumes ONTAP, también se requiere el rol de Cloud Volumes ONTAP Admin. Más información sobre link:reference-roles.html["Funciones y privilegios de backup y recuperación"]. https://docs.netapp.com/us-en/console-setup-admin/reference-iam-predefined-roles.html["Obtenga información sobre los roles de acceso a la NetApp Console para todos los servicios"^].

.Pasos
. En el menú de NetApp Backup and Recovery , seleccione *Inventario*.
. Seleccione una carga de trabajo para ver los detalles de protección.
. Seleccione el icono Accionesimage:../media/icon-action.png["Opción de acciones"] > *Ver detalles*.
. Selecciona la pestaña *Grupos de protección*, *Grupos de disponibilidad*, *Instancias* o *Bases de datos*.
