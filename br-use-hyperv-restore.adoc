...
Desde la página Restaurar, puedes restaurar un recurso, incluso si no recuerdas el nombre exacto, la ubicación en la que reside o la fecha en la que estuvo en buen estado por última vez. Puedes buscar la instantánea usando filtros.
...
Restaura cargas de trabajo Hyper-V usando el menú Restaurar. Puedes buscar la instantánea por su nombre o usando filtros.
