...
* ASP.NET Core Runtime 8.0.23 Hosting Bundle (y todos los parches posteriores de 8.0.x)
* PowerShell 7.4.13
...
*Requisitos de software para el host Hyper-V Windows Server*
...
* ONTAP 9.13.1 o posterior
* Amazon FSx para sistemas de almacenamiento NetApp ONTAP que ejecuten la versión 9.13.1 o posterior
* Almacenamiento SAN (vista previa) (compatible con copias de seguridad y restauración a la ubicación original desde almacenamiento primario y almacenamiento secundario)
