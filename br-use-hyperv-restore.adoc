...
* Restaurar desde una copia de seguridad de almacén de objetos (solo en la ubicación original)



NOTE: La restauración a partir de la copia de seguridad del almacén de objetos no es compatible con las máquinas virtuales que residen en el almacenamiento SAN.
...
* Restaurar en una ubicación alternativa (desde almacenamiento primario y secundario)
