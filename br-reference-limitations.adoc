...
* NetApp Backup & Recovery no admite la conversión de un FlexVol volume con una relación de respaldo en la nube activa a un volumen FlexGroup mientras mantiene la funcionalidad de respaldo en la nube.
