...
+
** Si es la primera vez que inicia sesión en Backup and Recovery y aún no ha agregado un sistema a la página *Sistemas*, Backup and Recovery muestra la página de inicio "Bienvenido a la nueva NetApp Backup and Recovery" con una opción para agregar un sistema. Para obtener detalles sobre cómo agregar un sistema a la página *Sistemas*, consulte https://docs.netapp.com/us-en/console-setup-admin/task-quick-start-standard-mode.html["Introducción al modo estándar de la NetApp Console"^].
...
** Para cargas de trabajo de Oracle Database, consulta link:br-start-discover-oracle.html["Descubre las cargas de trabajo de Oracle Database"].
