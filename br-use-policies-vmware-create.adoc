...
[role="lead"]
En NetApp Backup and Recovery, crea tus propias políticas de backup de VMware que determinan la frecuencia de backup, el tiempo de backup y la cantidad de archivos de backup que se conservan.
...
** *Configuración de VM*:
+
*** *Habilitar instantáneas consistentes con la VM y consistentes con las aplicaciones*: habilita esta opción para crear instantáneas consistentes con la VM y consistentes con las aplicaciones. Esto requiere que VMware Tools esté ejecutándose en la VM. Si VMware Tools no está ejecutándose, las instantáneas serán consistentes con los bloqueos. Ten en cuenta que habilitar esta opción puede aumentar el tiempo de backup y usar más almacenamiento. Además, la RAM activa de la VM no se incluye en las instantáneas consistentes.
