...
** Asegúrese de que la función de servicio Host Guardian esté instalada (consulte la https://learn.microsoft.com/en-us/windows-server/administration/server-manager/add-remove-roles-features?tabs=gui#add-roles-and-features-to-windows-server["Documentación de Microsoft Windows Server"^] (para instrucciones)
