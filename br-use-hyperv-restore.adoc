...
+
*Reiniciar la máquina virtual*: habilite esta opción para iniciar la nueva máquina virtual después de restaurarla.
...
--
No disponible para la vista previa de cargas de trabajo de Hyper-V.
