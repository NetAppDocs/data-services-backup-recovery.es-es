...
[role="lead"]
En NetApp Backup and Recovery, crea tus propias políticas de backup KVM que regulan la frecuencia de backup, el tiempo de backup y la cantidad de archivos de backup que se conservan.
