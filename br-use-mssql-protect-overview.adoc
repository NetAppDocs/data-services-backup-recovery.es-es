...
NetApp Backup and Recovery utiliza NetApp SnapMirror para sincronizar las copias de seguridad creando instantáneas y transfiriéndolas a las ubicaciones de copia de seguridad.
