...
* Crea grupos de protección para gestionar las operaciones de copia de seguridad y restauración de un conjunto de recursos. Consulta link:br-use-kvm-protection-groups.html["Gestiona grupos de protección KVM en NetApp Backup and Recovery"] para más información.
