...
---
= Mejora el rendimiento de la función Buscar y restaurar de volúmenes al usar una implementación local de NetApp Console
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
----
. Aplica los objetos YAML, primero el PV y luego el PVC (el PV debe existir para que el selector de etiquetas del PVC pueda vincularse a él). Luego verifica que la reclamación del PVC esté vinculada:
+
[source, shell]
----
