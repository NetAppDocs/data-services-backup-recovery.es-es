...
---
= Configura certificados de seguridad para NetApp Backup and Recovery
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
Si la comunicación entre los contenedores NetApp Backup and Recovery y StorageGRID debe verificar el certificado StorageGRID, entonces completa los siguientes pasos.
