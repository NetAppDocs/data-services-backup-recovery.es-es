...
---
= Descubre cómo gestionar las cargas de trabajo de Kubernetes con NetApp Backup and Recovery
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Gestionar cargas de trabajo de Kubernetes en NetApp Backup and Recovery te permite descubrir, gestionar y proteger tus clústeres y aplicaciones de Kubernetes, todo en un solo lugar. Puedes gestionar recursos y aplicaciones alojados en tus clústeres de Kubernetes. También puedes crear y asociar políticas de protección con tus aplicaciones de Kubernetes, todo usando una sola interfaz.
