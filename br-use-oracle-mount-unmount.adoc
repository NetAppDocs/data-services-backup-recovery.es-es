...
[role="lead"]
Monta un punto de recuperación de la base de datos Oracle cuando necesites acceder a la base de datos en un estado controlado para operaciones de recuperación. Si la catalogación automática está desactivada, puedes catalogar manualmente los metadatos del punto de recuperación en el catálogo de recuperación de RMAN.
...
== Desmontar un punto de recuperación de Oracle Database
...
== Catalogar un punto de recuperación de Oracle Database
