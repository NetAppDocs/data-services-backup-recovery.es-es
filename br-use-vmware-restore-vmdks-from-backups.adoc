...
---
= Restaura discos virtuales de VMware desde copias de seguridad en NetApp Backup and Recovery
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Restaura discos virtuales (VMDK) existentes, eliminados o desconectados a partir de backups primarios o secundarios de máquinas virtuales tradicionales. Esto te permite recuperar datos o aplicaciones específicos de una máquina virtual sin restaurar toda la máquina virtual. Una vez restaurado el disco virtual, se conecta a su máquina virtual original y ya está listo para usarse.
...
* Las operaciones de conexión y restauración conectan los VMDK mediante el controlador SCSI predeterminado. Sin embargo, si haces backup de VMDK que están conectados a una máquina virtual con un disco NVMe, las operaciones de conexión y restauración usan un controlador NVMe si hay uno disponible.
