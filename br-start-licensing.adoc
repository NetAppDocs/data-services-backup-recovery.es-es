...
* Si usas Backup and Recovery con NetApp Console, puedes suscribirte a la licencia de pago por uso (PAYGO) o comprar una licencia bring-your-own-license (BYOL).
...
Configura las licencias para NetApp Backup and Recovery.
...
=== Utiliza un contrato anual con licencias de marketplace o BYOL
...
== Configura las licencias para la implementación local de NetApp Backup and Recovery

Configura las licencias para la versión local de NetApp Console.
...
Usas la implementación local de la NetApp Console para gestionar licencias BYOL. Puedes añadir nuevas licencias, actualizar las existentes y ver el estado de las licencias desde la Console.
