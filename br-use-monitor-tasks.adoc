...
. Para mostrar columnas adicionales (Sistema, VM de almacenamiento, Nombre de usuario, Carga de trabajo, Nombre de la política, Etiqueta de instantánea), selecciona el signo más.
