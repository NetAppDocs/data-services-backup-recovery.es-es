...
Para saber cómo activarlo manualmente, consulta https://community.netapp.com/t5/Tech-ONTAP-Blogs/BlueXP-Backup-and-Recovery-July-2024-Release/ba-p/453993["Blog de lanzamiento de NetApp Backup and Recovery de julio de 2024"].
