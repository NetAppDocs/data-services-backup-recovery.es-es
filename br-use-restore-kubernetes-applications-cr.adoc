...
---
= Restaura aplicaciones de Kubernetes con NetApp Backup and Recovery usando un recurso personalizado
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
* Puedes usar la configuración avanzada para personalizar las operaciones de restauración. Para saber más, consulta link:br-use-kubernetes-advanced-restore-settings.html["Configuración avanzada de restauración para Kubernetes en NetApp Backup and Recovery"].
