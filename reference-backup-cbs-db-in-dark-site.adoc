...
También puedes seguir estos pasos para reemplazar el agente de la Consola y restaurar los datos de configuración que se almacenaron en él cuando usas Backup and Recovery en _standard mode_ en las instalaciones, cuando no hay cuentas en la nube involucradas (por ejemplo, cuando usas NetApp StorageGrid como destino de la copia de seguridad).
