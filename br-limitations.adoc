...
SnapCenter no tiene clústeres de almacenamiento ni máquinas virtuales de almacenamiento asignados a los recursos en los hosts, pero NetApp Backup and Recovery sí. El clúster ONTAP local o la máquina virtual de almacenamiento no se asignará a un host en las versiones preliminares de NetApp Backup and Recovery. Además, NetApp Console no es compatible con las máquinas virtuales de almacenamiento.
