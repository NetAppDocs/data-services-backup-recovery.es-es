...
[role="lead"]
Puedes usar Buscar y Restaurar para recuperar volúmenes, carpetas o archivos de los archivos de copia de seguridad de ONTAP. Buscar y Restaurar te permite buscar en todas las copias de seguridad (incluyendo instantáneas locales, volúmenes replicados y almacén de objetos) sin necesidad de nombres exactos de sistemas, volúmenes o archivos.
