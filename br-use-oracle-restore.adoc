...
** Elige un valor de tiempo de espera para el script. Si el script no se ejecuta dentro de ese plazo, la restauración se lleva a cabo de todos modos.
...
** *Abrir la base de datos o la base de datos contenedora en modo lectura/escritura tras la recuperación*: Una vez finalizada la operación de restauración, NetApp Backup and Recovery activa el modo lectura/escritura para la base de datos.
