...
+
*** *Cambiar ubicación de almacenamiento predeterminada*: Activa esta opción para restaurar una copia de seguridad del almacén de objetos en una máquina virtual de almacenamiento diferente en caso de que la ubicación de almacenamiento de origen sea inaccesible o esté llena. Elige un clúster, una máquina virtual de almacenamiento o un agregado diferente para usar.
