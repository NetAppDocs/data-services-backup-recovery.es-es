...
| Cloud Volumes ONTAP en almacenamiento de objetos compatible con S3  a| 
* Cloud Volumes ONTAP en almacenamiento de objetos compatible con S3
* Sistema ONTAP local
...
| Almacenamiento de objetos compatible con S3  a| 
* Cloud Volumes ONTAP en almacenamiento de objetos compatible con S3
* Sistema ONTAP local
