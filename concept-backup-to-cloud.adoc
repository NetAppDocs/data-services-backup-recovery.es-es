...
* *Cargas de trabajo VMware (con la nueva interfaz de usuario sin SnapCenter Plug-in for VMware vSphere)*:
+
** Proteja sus máquinas virtuales y almacenes de datos VMware con NetApp Backup and Recovery.
** Haz copias de seguridad de las cargas de trabajo de VMware en Amazon Web Services S3 o StorageGRID.
...
* Microsoft Azure Blob (no disponible para cargas de trabajo VMware)
* StorageGRID
* ONTAP S3 (no disponible para cargas de trabajo VMware)
