...
* Puedes restaurar una *carpeta* desde instantáneas replicadas o de almacenamiento de objetos a un volumen en el sistema original, a un volumen en un sistema diferente que use la misma cuenta en la nube o a un volumen en un sistema ONTAP local. No se admite la restauración de carpetas desde instantáneas locales.
