...
** Si creas copias locales de Snapshots en el volumen de destino de SnapMirror (independientemente de las etiquetas de SnapMirror que uses), estos Snapshots no se moverán a la nube como backups. Debes crear una Snapshot policy con las etiquetas que quieras en el volumen de origen DP para que NetApp Backup and Recovery pueda hacerles backup.
