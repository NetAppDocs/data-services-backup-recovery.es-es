...
[role="lead"]
Restaure bases de datos Oracle a partir de instantáneas, de una copia de seguridad replicada en almacenamiento secundario o de copias de seguridad almacenadas en almacenamiento de objetos mediante NetApp Backup and Recovery.
