...
* Crea grupos de protección para gestionar las operaciones de copia de seguridad y restauración de un conjunto de recursos. Consulta link:br-use-hyperv-protection-groups.html["Crea y gestiona grupos de protección de Hyper-V en NetApp Backup and Recovery"] para más información.
