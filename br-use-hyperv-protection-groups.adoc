...
. Cambie cualquier configuración del grupo de protección, como el nombre o qué máquinas virtuales están en el grupo.
. Seleccione *Siguiente*.
. Cambie la política de protección si es necesario. Cuando haya terminado, seleccione *Siguiente*.
