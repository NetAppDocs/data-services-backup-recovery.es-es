...
. Adjuntar
+
Conecte un disco virtual a una máquina virtual invitada o una máquina virtual proxy e inicie una sesión de restauración de archivos de invitado.
...
* Si restaura un archivo o una carpeta cifrados, el atributo de cifrado no se conserva. No se pueden restaurar archivos o carpetas en una carpeta cifrada.
* La página de exploración de archivos de invitado muestra los archivos y carpetas ocultos que no se pueden filtrar.
