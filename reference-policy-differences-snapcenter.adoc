...
---
= Diferencias de políticas entre SnapCenter y NetApp Backup and Recovery
:hardbreaks:
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
[role="lead"]
Utiliza esta referencia para entender las diferencias de políticas entre SnapCenter y NetApp Backup and Recovery que pueden afectar a los recursos y políticas importados.
...
NetApp Backup and Recovery utiliza los siguientes niveles de programación, que difieren ligeramente:
...
* Si la planificación de SnapCenter se establece en más de 7 días, NetApp Backup and Recovery establece la planificación en mensual. Algunas instantáneas se omitirán durante el mes.
+
...
*Ejemplo*: Si tienes una política horaria en SnapCenter con un intervalo de repetición cada 5 horas a partir de la 1:00 AM, NetApp Backup and Recovery (después de la migración) establecerá la programación como diaria con intervalos de 5 horas a la 1:00 AM, 6:00 AM, 11:00 AM, 4:00 PM y 9:00 PM. Se omitirán algunas horas: después de las 9:00 PM debería ser a las 2:00 AM para repetir cada 5 horas, pero siempre será a la 1:00 AM.
