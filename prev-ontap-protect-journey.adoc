...
---
= Opciones de planificación del proceso de protección en NetApp Backup and Recovery
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
Además de estos criterios, el almacenamiento en la nube ofrece opciones de seguridad adicionales si usas la función *Datalock and Ransomware protection*, y ahorros de costes adicionales al seleccionar clases de almacenamiento de archivo para los archivos de backup más antiguos. link:prev-ontap-policy-object-options.html["Obtenga más información sobre la protección contra DataLock y Ransomware y la configuración de almacenamiento de archivos."].
