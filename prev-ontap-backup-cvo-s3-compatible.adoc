...
* Probado y validado con Wasabi object storage; los clientes también han informado implementaciones satisfactorias con MinIO, IBM Cloud Object Storage y Apple Object Store
