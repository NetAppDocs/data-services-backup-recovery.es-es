...
[role="lead"]
Puedes reiniciar NetApp Backup and Recovery desde el host del agente de la NetApp Console cuando necesites recuperar el servicio o aplicar un cambio. Usa el comando que coincida con tu tipo de implementación y el runtime de contenedores.

El agente de consola incluye la funcionalidad de NetApp Backup and Recovery .

.Pasos
. Conéctate al sistema Linux donde se está ejecutando el agente de consola.
+
[cols="25,50"]
|===
