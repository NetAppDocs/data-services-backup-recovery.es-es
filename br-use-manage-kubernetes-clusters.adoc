...
Para los clústeres de Kubernetes que ejecutan Trident Protect 26.04 o posterior, puedes actualizar Trident Protect directamente desde NetApp Backup and Recovery. La opción de actualización solo aparece si hay disponible una versión más reciente.
