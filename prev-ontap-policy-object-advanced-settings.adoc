...
---
= Gestiona las opciones de copia de seguridad a almacenamiento de objetos en NetApp Backup and Recovery
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
Para obtener más información sobre las opciones de protección Datalock y Ransomware, consulta link:prev-ontap-policy-object-options.html["Opciones de protección de Datalock y ransomware"].
